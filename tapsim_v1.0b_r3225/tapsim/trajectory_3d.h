...
class Trajectory_3d
{
	public:
		...
		static constexpr float eCharge = 1.60217733e-19;	// [eCharge] = C
		static constexpr float protonMass = 1.6726231e-27;	// [protonMass] = kg
		static constexpr float amu2kg = 1.660538782e-27;	// [amu2kg] = kg/amu
	...
	private:
		...
		static constexpr float _safetyFactor = 0.9f;
